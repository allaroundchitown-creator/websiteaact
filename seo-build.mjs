...
const schemaFor = p => JSON.stringify({
  '@context':'https://schema.org','@graph':[
    {'@type':'LocalBusiness','@id':`${domain}/#business`,name:'AACT Booths',alternateName:'All Around Chi Town',url:`${domain}/`,telephone:'+1-224-234-1473',email:'allaroundchitown@gmail.com',logo:`${domain}/all-around-chi-town-logo-transparent.png`,areaServed:p.city ? p.city : 'Chicagoland'},
